...
struct Star
{
    ...
    int mass;
    COLORREF color;
    vector< double > singleStepX;
    vector< double > singleStepY;
};
...
double getSum(vector< double > &input)
{
    double temp = 0;
    for(int i = 0; i < input.size(); i ++)
        temp += input[i];
...
double getAverage(vector< double > &input)
{
    return getSum(input)/input.size();
}

double getMidvalue(vector< double > &input)
{
    sort(input.begin(),input.end());
    double result;
    if(input.size() % 2 == 0)
    {
        result = input[input.size()/2] + input[input.size()/2 + 1];
        result /= 2;
    }
    else
...
double getMaximum(vector< double > &input)
{
    return *max_element(input.begin(),input.end());
}

void printStatistic(vector< Star > &input)
{
    cout << endl;
    cout << "============================= Statistic =============================" << endl;
    cout << "|-------------------------------------------------------------------|" << endl;
    ...
    cout << "|" << left << setw(14) << "  Average";
    cout << "|" << left << setw(14) << "  Midvalue";
    cout << "|" << left << setw(14) << "  Maximum";
    cout << "|" << endl;
    cout << "|-------------------------------------------------------------------|" << endl;
    ...
    for(int i = 0; i < input.size(); i ++)
    {
        ...
        cout << "|" << "  ( " << right << setw(8) << fixed << setprecision(precision) << getSum(input[i].singleStepX);
        cout << "," << right << setw(8) << setprecision(precision) << getSum(input[i].singleStepY) << " )  ";

        cout << "|" << "  ( " << right << setw(6) << fixed << setprecision(precision) << getAverage(input[i].singleStepX);
        cout << "," << right << setw(6) << setprecision(precision) << getAverage(input[i].singleStepY) << " )  ";

        cout << "|" << "  ( " << right << setw(6) << fixed << setprecision(precision) << getMidvalue(input[i].singleStepX);
        cout << "," << right << setw(6) << setprecision(precision) << getMidvalue(input[i].singleStepY) << " )  ";

        cout << "|" << "  ( " << right << setw(6) << fixed << setprecision(precision) << getMaximum(input[i].singleStepX);
        cout << "," << right << setw(6) << setprecision(precision) << getMaximum(input[i].singleStepY) << " )  ";
...
void applyCoordinate(Star &input)
{
    ...
    input.singleStepX.push_back(input.TEMPx - input.x);
    input.singleStepY.push_back(input.TEMPy - input.y);
}
...
int start_simulation()
{
    ...
    {
        printResult(list);
        //TODO: ask if print statistic result
        printStatistic(list);
        system("pause");
    }
